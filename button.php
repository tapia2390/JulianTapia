...
<!-- Imprimir -->
<div class="modal fade" id="imprimir<?php echo $row['id']; ?>" tabindex="-1" role="dialog"
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="container-fluid" id="container-fluid">
					...
					<h2>
						<center>Placa: <strong
								style="color:blue;text-transform:uppercase;"><?php echo ucwords($drow['placa']); ?></strong>
						</center>
					</h2>
					<h3>
					...
					<h3>
						<center>Descripción: <strong> <br /> <?php echo ucwords($drow['descripcion']); ?></strong>
						</center>
					</h3>
					...
					<h5>
						<center>Valor cobrado: <strong>
								...
								if ($horas > 0 && $horas <= 5 && $minutos > 9) {
									...
									$valoracobrar += $sumahoraconminutos;
					...
					<input type="hidden" id="valor_cobrado" name="valor_cobrado" class="form-control"
						value="<?php echo $valoracobrar; ?>">
					<input type="hidden" id="fecha_salida" name="fecha_salida" class="form-control"
						value="<?php echo $fecha_salida->format('Y-m-d H:i:s'); ?>">
			...
			<div class="modal-footer">
				...
				<a href="edit2.php?<?php echo $_id ?>&<?php echo $_valor_cobrado ?>&<?php echo $_fecha_salida ?>"
					style="cursor: pointer;">Generar pago</a>
			</div>
				...
				<div class="container-fluid">
					<form method="POST" action="edit.php?id=<?php echo $erow['id']; ?>">
						<div class="row">
							...
							<div class="col-lg-10">
								<input type="text" style="text-transform:uppercase" name="placa" class="form-control"
									value="<?php echo $erow['placa']; ?>">
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="col-lg-10">
								<input type="text" style="text-transform:uppercase" name="cascos" class="form-control"
									value="<?php echo $erow['cascos']; ?>">
							</div>
						</div>
						<div style="height:10px;"></div>
						...
						<div class="row">
							...
							<div class="col-lg-10">
								<input type="text" style="text-transform:uppercase" name="ubicacion"
									class="form-control" value="<?php echo $erow['ubicacion']; ?>">
							</div>
						</div>
						<div style="height:10px;"></div>
						...
						<div class="row">
							...
							<div class="col-lg-10">
								<input type="text" style="text-transform:uppercase" name="descripcion"
									class="form-control" value="<?php echo $erow['descripcion']; ?>">
							</div>
						</div>
